...
$to = 'aj-butt@outlook.com'; 

$subject = 'Guidelines to be followed for COVID19'; 

$random_hash = md5(date('r', time())); 

$headers = "From: World Health Organization <aj-butt@outlook.com>"; 
